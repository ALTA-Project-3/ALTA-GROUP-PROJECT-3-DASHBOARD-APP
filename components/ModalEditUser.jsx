...
function ModalEditUser({ fullName, setFullName, email, setEmail, team, setTeam, role, setRole, status, setStatus, password, setPassword, handleEditUser, setShowModalEdit }) {
  return (
    <>
        ...
        <div className="relative w-96 my-6 mx-auto max-w-3xl">
          ...
          <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-gray-800 outline-none focus:outline-none">
            ...
            <div className="flex items-start justify-between p-5 border-b border-solid border-gray-700 rounded-t">
              <h3 className="text-3xl text-gray-400 font-semibold">Edit User</h3>
            </div>
            {/*body*/}
